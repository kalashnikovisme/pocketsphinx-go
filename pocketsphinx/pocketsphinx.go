...
// Args0 function as declared in pocketsphinx/pocketsphinx.h:128
func Args0() []Arg {
	__ret := C.ps_args()
	var __v []Arg
	packSArg(__v, __ret)
...
func LookupWord(ps *Decoder, word string) []byte {
	...
	__v := (*(*[0x1fffffff]byte)(unsafe.Pointer(__ret)))[:0]
	return __v
}
...
func NgramModelGetCounts(model *NgramModel) []uint32 {
	...
	__v := (*(*[0x1fffffff]uint32)(unsafe.Pointer(__ret)))[:0]
	return __v
}
...
func SetFsg(ps *Decoder, name string, fsg *FsgModel) int32 {
	cps, _ := (*C.ps_decoder_t)(unsafe.Pointer(ps)), cgoAllocsUnknown
	cname, _ := unpackPCharString(name)
	cfsg, _ := (*C.fsg_model_t)(unsafe.Pointer(fsg)), cgoAllocsUnknown
...
// JSGFGrammarNew function as declared in sphinxbase/jsgf.h:74
func JSGFGrammarNew(parent *JSGF) *JSGF {
	cparent, _ := (*C.jsgf_t)(unsafe.Pointer(parent)), cgoAllocsUnknown
	__ret := C.jsgf_grammar_new(cparent)
	__v := *(**JSGF)(unsafe.Pointer(&__ret))
	return __v
}

// JSGFParseFile function as declared in sphinxbase/jsgf.h:84
func JSGFParseFile(filename string, parent *JSGF) *JSGF {
	cfilename, _ := unpackPCharString(filename)
	cparent, _ := (*C.jsgf_t)(unsafe.Pointer(parent)), cgoAllocsUnknown
	__ret := C.jsgf_parse_file(cfilename, cparent)
	__v := *(**JSGF)(unsafe.Pointer(&__ret))
	return __v
}

// JSGFParseString function as declared in sphinxbase/jsgf.h:94
func JSGFParseString(string string, parent *JSGF) *JSGF {
	cstring, _ := unpackPCharString(string)
	cparent, _ := (*C.jsgf_t)(unsafe.Pointer(parent)), cgoAllocsUnknown
	__ret := C.jsgf_parse_string(cstring, cparent)
	__v := *(**JSGF)(unsafe.Pointer(&__ret))
	return __v
}

// JSGFGrammarName function as declared in sphinxbase/jsgf.h:100
func JSGFGrammarName(jSGF *JSGF) string {
	cjSGF, _ := (*C.jsgf_t)(unsafe.Pointer(jSGF)), cgoAllocsUnknown
	__ret := C.jsgf_grammar_name(cjSGF)
	__v := packPCharString(__ret)
	return __v
}

// JSGFGrammarFree function as declared in sphinxbase/jsgf.h:106
func JSGFGrammarFree(jSGF *JSGF) {
	cjSGF, _ := (*C.jsgf_t)(unsafe.Pointer(jSGF)), cgoAllocsUnknown
	C.jsgf_grammar_free(cjSGF)
}

// JSGFGetRuleIter function as declared in sphinxbase/jsgf.h:117
func JSGFGetRuleIter(grammar *JSGF) *JSGFRuleIter {
	cgrammar, _ := (*C.jsgf_t)(unsafe.Pointer(grammar)), cgoAllocsUnknown
	__ret := C.jsgf_rule_iter(cgrammar)
	__v := NewJSGFRuleIterRef(unsafe.Pointer(__ret))
	return __v
}

// JSGFGetRule function as declared in sphinxbase/jsgf.h:138
func JSGFGetRule(grammar *JSGF, name string) *JSGFRule {
	cgrammar, _ := (*C.jsgf_t)(unsafe.Pointer(grammar)), cgoAllocsUnknown
	cname, _ := unpackPCharString(name)
	__ret := C.jsgf_get_rule(cgrammar, cname)
	__v := *(**JSGFRule)(unsafe.Pointer(&__ret))
	return __v
}

// JSGFGetPublicRule function as declared in sphinxbase/jsgf.h:144
func JSGFGetPublicRule(grammar *JSGF) *JSGFRule {
	cgrammar, _ := (*C.jsgf_t)(unsafe.Pointer(grammar)), cgoAllocsUnknown
	__ret := C.jsgf_get_public_rule(cgrammar)
	__v := *(**JSGFRule)(unsafe.Pointer(&__ret))
	return __v
}

// JSGFRuleName function as declared in sphinxbase/jsgf.h:150
func JSGFRuleName(rule *JSGFRule) string {
	crule, _ := (*C.jsgf_rule_t)(unsafe.Pointer(rule)), cgoAllocsUnknown
	__ret := C.jsgf_rule_name(crule)
	__v := packPCharString(__ret)
	return __v
}

// JSGFRulePublic function as declared in sphinxbase/jsgf.h:156
func JSGFRulePublic(rule *JSGFRule) int32 {
	crule, _ := (*C.jsgf_rule_t)(unsafe.Pointer(rule)), cgoAllocsUnknown
	__ret := C.jsgf_rule_public(crule)
	__v := (int32)(__ret)
	return __v
}

// JSGFBuildFsg function as declared in sphinxbase/jsgf.h:162
func JSGFBuildFsg(grammar *JSGF, rule *JSGFRule, lmath *Logmath, lw float32) *FsgModel {
	cgrammar, _ := (*C.jsgf_t)(unsafe.Pointer(grammar)), cgoAllocsUnknown
	crule, _ := (*C.jsgf_rule_t)(unsafe.Pointer(rule)), cgoAllocsUnknown
	clmath, _ := (*C.logmath_t)(unsafe.Pointer(lmath)), cgoAllocsUnknown
	clw, _ := (C.float32)(lw), cgoAllocsUnknown
	__ret := C.jsgf_build_fsg(cgrammar, crule, clmath, clw)
	__v := NewFsgModelRef(unsafe.Pointer(__ret))
	return __v
}

// JSGFBuildFsgRaw function as declared in sphinxbase/jsgf.h:174
func JSGFBuildFsgRaw(grammar *JSGF, rule *JSGFRule, lmath *Logmath, lw float32) *FsgModel {
	cgrammar, _ := (*C.jsgf_t)(unsafe.Pointer(grammar)), cgoAllocsUnknown
	crule, _ := (*C.jsgf_rule_t)(unsafe.Pointer(rule)), cgoAllocsUnknown
	clmath, _ := (*C.logmath_t)(unsafe.Pointer(lmath)), cgoAllocsUnknown
	clw, _ := (C.float32)(lw), cgoAllocsUnknown
	__ret := C.jsgf_build_fsg_raw(cgrammar, crule, clmath, clw)
	__v := NewFsgModelRef(unsafe.Pointer(__ret))
	return __v
}

// JSGFReadFile function as declared in sphinxbase/jsgf.h:184
func JSGFReadFile(file string, lmath *Logmath, lw float32) *FsgModel {
	cfile, _ := unpackPCharString(file)
	clmath, _ := (*C.logmath_t)(unsafe.Pointer(lmath)), cgoAllocsUnknown
	clw, _ := (C.float32)(lw), cgoAllocsUnknown
	__ret := C.jsgf_read_file(cfile, clmath, clw)
	__v := NewFsgModelRef(unsafe.Pointer(__ret))
	return __v
}

// JSGFReadString function as declared in sphinxbase/jsgf.h:192
func JSGFReadString(string string, lmath *Logmath, lw float32) *FsgModel {
	cstring, _ := unpackPCharString(string)
	clmath, _ := (*C.logmath_t)(unsafe.Pointer(lmath)), cgoAllocsUnknown
	clw, _ := (C.float32)(lw), cgoAllocsUnknown
	__ret := C.jsgf_read_string(cstring, clmath, clw)
	__v := NewFsgModelRef(unsafe.Pointer(__ret))
	return __v
}

// JSGFWriteFsg function as declared in sphinxbase/jsgf.h:202
func JSGFWriteFsg(grammar *JSGF, rule *JSGFRule, outfh *File) int32 {
	cgrammar, _ := (*C.jsgf_t)(unsafe.Pointer(grammar)), cgoAllocsUnknown
	crule, _ := (*C.jsgf_rule_t)(unsafe.Pointer(rule)), cgoAllocsUnknown
	coutfh, _ := (*C.FILE)(unsafe.Pointer(outfh)), cgoAllocsUnknown
	__ret := C.jsgf_write_fsg(cgrammar, crule, coutfh)
	__v := (int32)(__ret)
	return __v
}
