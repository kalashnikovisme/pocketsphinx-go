...
func (x *Arg) PassRef() (*C.arg_t, *cgoAllocMap) {
	...
	allocs8495e8ec.Add(mem8495e8ec)
...
func (x *FsgLink) PassRef() (*C.fsg_link_t, *cgoAllocMap) {
	...
	allocse7ca59ff.Add(meme7ca59ff)
...
func (x *FsgModel) Ref() *C.fsg_model_t {
	...
	return (*C.fsg_model_t)(unsafe.Pointer(x))
}
...
// NewFsgModelRef converts the C object reference into a raw struct reference without wrapping.
func NewFsgModelRef(ref unsafe.Pointer) *FsgModel {
	return (*FsgModel)(ref)
}

// NewFsgModel allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewFsgModel() *FsgModel {
	return (*FsgModel)(allocFsgModelMemory(1))
}
...
// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *FsgModel) PassRef() *C.fsg_model_t {
	if x == nil {
		x = (*FsgModel)(allocFsgModelMemory(1))
	}
	return (*C.fsg_model_t)(unsafe.Pointer(x))
}
...
// Ref returns a reference to C object as it is.
func (x *JSGF) Ref() *C.jsgf_t {
	if x == nil {
		return nil
	}
	return (*C.jsgf_t)(unsafe.Pointer(x))
}
...
// NewJSGFRef converts the C object reference into a raw struct reference without wrapping.
func NewJSGFRef(ref unsafe.Pointer) *JSGF {
	return (*JSGF)(ref)
}

// NewJSGF allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewJSGF() *JSGF {
	return (*JSGF)(allocJSGFMemory(1))
}

// allocJSGFMemory allocates memory for type C.jsgf_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocJSGFMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfJSGFValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfJSGFValue = unsafe.Sizeof([1]C.jsgf_t{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *JSGF) PassRef() *C.jsgf_t {
	if x == nil {
		x = (*JSGF)(allocJSGFMemory(1))
	}
	return (*C.jsgf_t)(unsafe.Pointer(x))
}

// Ref returns a reference to C object as it is.
func (x *JSGFRule) Ref() *C.jsgf_rule_t {
	if x == nil {
		return nil
	}
	return (*C.jsgf_rule_t)(unsafe.Pointer(x))
}

// Free cleanups the referenced memory using C free.
func (x *JSGFRule) Free() {
	if x != nil {
		C.free(unsafe.Pointer(x))
	}
}

// NewJSGFRuleRef converts the C object reference into a raw struct reference without wrapping.
func NewJSGFRuleRef(ref unsafe.Pointer) *JSGFRule {
	return (*JSGFRule)(ref)
}

// NewJSGFRule allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewJSGFRule() *JSGFRule {
	return (*JSGFRule)(allocJSGFRuleMemory(1))
}

// allocJSGFRuleMemory allocates memory for type C.jsgf_rule_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocJSGFRuleMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfJSGFRuleValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfJSGFRuleValue = unsafe.Sizeof([1]C.jsgf_rule_t{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *JSGFRule) PassRef() *C.jsgf_rule_t {
	if x == nil {
		x = (*JSGFRule)(allocJSGFRuleMemory(1))
	}
	return (*C.jsgf_rule_t)(unsafe.Pointer(x))
}
...
// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *JSGFRuleIter) Ref() *C.hash_iter_t {
	if x == nil {
		return nil
	}
...
// NewJSGFRuleIterRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewJSGFRuleIterRef(ref unsafe.Pointer) *JSGFRuleIter {
	if ref == nil {
		return nil
	}
	obj := new(JSGFRuleIter)
...
// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *JSGFRuleIter) PassRef() (*C.hash_iter_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	...
	allocsb26723b3.Add(memb26723b3)
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x JSGFRuleIter) PassValue() (C.hash_iter_t, *cgoAllocMap) {
